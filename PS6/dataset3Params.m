...
%These are the values used to estimate C_list and s_list
%using the optimal values found for speed of computation on the pset.
C_list = [0.1, 0.3, 1, 3, 10, 30, 100];
s_list = [.01, .03, 0.1, 0.3, 1];


% create a blank results matrix
% col 1: err_val ; col 2: C ; col_3: s
...
%if output is wrong, print results, min_err, C, and sigma to check
